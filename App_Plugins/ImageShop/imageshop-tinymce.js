        ...
        function plugin(tinymce) {
            ...
            tinymce.PluginManager.add('imageshop', function (editor) {
                ...
                if (hostUrl.includes('undefined')) {
                    var urlParts = editor.documentBaseUrl.match(/^(\w+:)\/\/([^:/?]+)(?::(\d+))?/);
                    if (urlParts) {
                ...
                function getLocalizedButtonTitles() {
                    ...
                    return localizedTitles['en']; // Default to English if locale not found
                }
                ...
                var controllerPath = "/umbraco/api/imageshop/insertimage/";
                var dialogUrl = hostUrl + controllerPath + "?TINYMCE=true&TINYMCEEXTENDED=true&CULTURE=" + "en" + "&IMAGESHOPLANGUAGE=" + "en" + "&rnd=" + generateRandomFiveDigitNumber();//or epi.dependency.resolve("epi.cms.contentEditing.command.Editing").model.languageContext.language; 
                ...
                if (tinymce.majorVersion >= 5) {
                    ...
                    editor.ui.registry.addButton('imageshop', {
                        ...
                        onAction: function () {
                            try {
                                ...
                                if (editor.selection !== null && editor.selection.getNode() && editor.selection.getNode().src)
                                    currentDialogUrl += "&image=" + encodeURIComponent(editor.selection.getNode().src);
                        ...
                        onSetup: function (api) {
                            ...
                            const nodeChangeHandler = function (e) {
                                var isWebShopImage = e.element.tagName === "IMG" && (editor.dom.getAttrib(e.element, "class").indexOf("ScrImageshopImage") > -1 || editor.dom.getAttrib(e.element, "class").indexOf("mceItem") === -1);
                    ...
                    editor.ui.registry.addButton('imageshopvideo', {
                        ...
                        onAction: function () {
                            try {
                                ...
                                if (editor.selection !== null && editor.selection.getNode() && editor.selection.getNode().src)
                                    currentDialogUrl += "&video=" + encodeURIComponent(editor.selection.getNode().src);
                    ...
                    // Register commands
                    editor.addCommand('mceimageshop', function () {

                        try {
                            var currentDialogUrl = dialogUrl;

                            if (editor.selection !== null && editor.selection.getNode() !== null && editor.selection.getNode().src !== null)
                                dialogUrl += "&image=" + encodeURIComponent(editor.selection.getNode().src);
                            ...
                            console.log("Error running command mceimageshopplugin: " + error);
                        }
                    });

                    // Register buttons
                    editor.addButton("imageshopplugin", {
                        title: buttonTitle,
                        cmd: "mceimageshopplugin",
                        image: buttonIcon,
                ...
                return {
                    getMetadata: function () {
                        return {
                            name: "Imageshop Umbraco plugin",
                            url: "https://github.com/imageshoporg/Umbraco",
                            author: 'Digitroll AS, Imageshop, tinymce ' + tinymce.majorVersion + '.' + tinymce.minorVersion,
                            authorurl: 'https://github.com/imageshoporg/Umbraco',
                            infourl: 'https://github.com/imageshoporg/Umbraco',
